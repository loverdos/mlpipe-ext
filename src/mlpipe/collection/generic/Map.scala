...
object Map extends MapOps {
  ...
  protected implicit def canBuildFrom[A, B] = CMap.canBuildFrom.asInstanceOf[CanBuildFrom[CMap[A, B], (A, B), MapImpl[A, B]]]

//  final val MapImplF = CMap
  def empty[A, B] = CMap.empty[A, B]
}
