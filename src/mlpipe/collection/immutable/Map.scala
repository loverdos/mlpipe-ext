...
object Map extends MapOps {
  ...
  protected implicit def canBuildFrom[A, B] = ImMap.canBuildFrom.asInstanceOf[CanBuildFrom[CMap[A, B], (A, B), MapImpl[A, B]]]

//  final val MapImplF = ImMap
  def empty[A, B] = ImMap.empty[A, B]
}
